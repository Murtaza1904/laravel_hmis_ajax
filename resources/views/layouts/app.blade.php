...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max.height-vh-100 h-100 border-radius-lg ">
        <nav class="navbar navbar-main navbar-expand-lg plivewire:components.0 mlivewire:components.4 shadow-none border-radius-xl"
                    ...
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        ...
                        <ul class="navbar-nav  justify-content-end">
                            ...
                            <li class="nav-item d-flex align-items-center">
                                {{-- <a href="javascript:;"
                                    class="nav-link text-body font-weight-bold plivewire:components.0">
                                    <i class="fa fa-user me-sm-1"></i>
                                    <span class="d-sm-inline d-none">{{ auth()->user()->name }}</span>
                                </a> --}}
                                <div class="btn-group dropstart">
                                    <a class="nav-link text-body font-weight-bold plivewire:components.0" href="#"
